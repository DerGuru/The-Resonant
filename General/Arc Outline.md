...
**Narrative promises**
- We *will* find Elyra.
- Jason learns precision over power; RAE privileges ethics over speed.
- The world is subtly hostile to harmonic outliers; institutions prefer control.

**Safety & Channel Protocol (diegetic rules)**
- Consent → **Slow channel** → Numbers/Archive‑first → **“Red stops”**.
- Jason can carry a *slow, verbal* channel all day with water & salt; faster channels risk headaches/nosebleed and sensory overload.
- **Carrier Phone Alibi (v0.1):** Dedicated prepaid handset “**figleaf**”, ≤90s bursts + cooldown, never record, avoid echo/glass, maintain Jason contact with phone or linked carrier, monthly SIM rotation.
- figleaf is deprecated short after when they started using whisper-clips. 

**Mechanics anchors**
- **Invest** = directed strain; **Quality** = alignment of shape; **Firmness** = structural tolerance.
- **Rituals** trade quality for quantity; *resonograms* are rigid, noisier; Jason+RAE favor small, high‑quality, on‑the‑fly shapes to minimize signature.

**Recurring motifs (foreshadowing)**
- Asynchronous shadows; triple pulse from a core; photographs that go missing; unmarked car; a street musician’s silencing melody; old monitors’ single‑eye LEDs; a cup that “talks.”
...
**Key Beats:** Invest/Quality/Firmness mapped onto small household carriers; the hard **“Red”** stop; insistence on *carriers only*; pocket **safety card** is finalized.  
...
**Key Beats:** Carrier drills (rail → kettle → cutlery); one hard **Red** (pressure spike); Lina reads room, calls stop; Jason’s pocket **safety card**; Milo times cool‑downs.
...
**Key Beats:** Boring‑on‑purpose check‑in; **paper‑first** ladder; **vanishing line** when Jason over‑focuses; **Red** micro‑event; Gen‑3 **ping** near a handrail.
...
**Key Beats:** Route rehearsal; carrier discipline (mug/bench/lattice); **Red** near river; civic‑intent read; pillar notice: **Use the street, not the gap.**
**Post‑scene Debrief:** Jason proposes **carrier phone alibi (v0.1)**; rules and risks codified; handset nicknamed **figleaf**.
...
**Key Beats:** Dealer dangled “map that proves everything”; price: data + favor; Milo asks for **receipts**; when pressed, the dealer’s wall clock ticks off‑beat; retreat with dignity.
...
**Key Beats:** Prototype two-point overlay for the city; RAE’s mute toggle tested; baseline *floor control* established.  
...
**Key Beats:** Agent offers protection for “predictable behavior”; RAE flags tailing; Jason refuses to sign any “understanding”; a **tiny resonance marker** appears on the restaurant doorframe after they leave.
...
**Key Beats:** Plausible cover (meter reading); flickering loop readings; guard vehicle sweep; Lina calls route **B**; they exit while still “boring.”
...
**Key Beats:** Disturbance blooms; Jason applies **two‑shape cancel** (tiny, clean); RAE stays silent due to busker’s line; incident resolves with no spectacle.
...
**Key Beats:** Lina’s shift warmth; Milo naps at archive; Jason’s boss warns about “risking compliance”; quiet talk about what *matters*.
...
**Key Beats:** Fit‑check; bone‑buzz confirmation; **floor: Lina**; **cost curves** made explicit (2 streams stable; 3 = short burst → cooldown).  
...
**Key Beats:** Object hums in Jason’s palm; RAE flickers with memory shards; they buy it as “metal scrap”; Jason later dreams of **metallic smell + drip‑echo**.
...
**Key Beats:** Contact verifies Elyra sighting; demands a *shape answer* not a story; Jason passes by aligning a cup’s ring; a guarded name surfaces.
...
**Key Beats:** RAE identifies resonance decoy; they stand down without poking the trap; document quietly and leave.
...
**Key Beats:** Lina/Jason hold position; Milo remote support; data refuses known shapes; lightning strikes at suspicious intervals; they mark timings.
...
**Key Beats:** Barter for parts; learn about **cores**; a vendor knows **Lina’s name**; they leave with gear and a sliver of dread.
...
**Key Beats:** **Doorframe marker** reappears; silent remove‑attempt leaves a *counter‑signature*; RAE logs spectral fingerprint.  
...
**Key Beats:** Retrieve **coded signal** can; meter flickers with no power; they copy the can’s scratches.
...
**Key Beats:** Milo’s pattern extraction; Jason holds **micro‑locks** cleanly; result: a reliable **three‑beat window** to work in.  
...
**Key Beats:** **Core hum** resonates; *not Elyra, but near*; breadcrumb map updated.  
...
**Key Beats:** Recalibration attempt fails; a device **dies**; Jason/Lina improvise a safe halt; that night both hear the same **single click** in different places.
...
**Key Beats:** Hidden inscription with **signature fragment**; Jason photographs it; later the photo is **missing**.
...
**Key Beats:** Coordination meets an **unknown party**; tense exchange; they leave with a location and a dare.
**Exit Image:** **Unmarked car** follows them home at an always‑legal distance.
**Locks:** Car reappears after the ritual.
...
**Key Beats:** Elyra “tests by riddle”; Jason answers by shaping a pebble’s *resting place*; RAE annotates silently; minimal approval granted.
...
**Key Beats:** Soil textures as field sensors; cooking for **Invest control**; walking for **drift study**; Jason finds a softly humming **stone**.
...
**Key Beats:** RAE goes silent under the busker’s melody; Jason practices without her voice; the difference is instructive and unnerving.
...
**Key Beats:** Timed task; Jason+RAE react in clean sync; Elyra offers first open praise; a distant tower light **dies in sync**.
...
**Key Beats:** **Floor control**, hand signals, timings; 2‑stream stable, 3rd permissible only in short pulses → enforced cooldown; **bone‑buzz** confirmation ritual.  
...
**Key Beats:** Stone sets the τ window; Jason practices *stir‑and‑relax* micro‑locks; metronome goes quiet **only** in his hand.  
...
**Key Beats:** Acquire a **rare core**; minor scuffle; Jason coordinates exit; core **pulses three times** then still.
...
**Key Beats:** 1‑2‑3 cadence; Elyra demonstrates **counter‑shape** reply; RAE stores reference segment.  
...
**Key Beats:** Jason pushes alone; overload; RAE throttles gently; he admits limits.
...
**Key Beats:** Take apart spiral decoys; establish “quiet wins” doctrine; dust patterns *almost* in sync.  
...
**Key Beats:** Elyra counters Dorian’s school; Jason commits to **help, but precise**.  
...
**Key Beats:** Elyra teaches coupling; Jason tests with Milo; unstable results; instrument spike matches **neither** signature.
...
**Key Beats:** Drill fails; Jason doubts; RAE steadies; Elyra reveals she “almost lost everything.”
...
**Key Beats:** Two‑shape cancel averts near‑crash; Dorian watches **without** stepping in.  
...
**Key Beats:** RAE stores a **private segment** (leak‑safe) → seed for later trust conflict; Elyra senses change but doesn’t call it out.  
...
**Key Beats:** Hard task solved cleanly; small celebration; RAE secretly stores Jason’s **solution path**.
...
**Key Beats:** Divide tasks; run acquisitions; Lina finds a **symbol** on a note she didn’t write.
...
**Key Beats:** Opsec routes; **unmarked car** sighted; checklists finalized.  
...
**Key Beats:** Carrier priority: **clip → room → free**; last hardware pass; gut‑check.  
...
**Key Beats:** Composite exercise; Elyra: “You’re ready.” Then: “One technique isn’t from me,” looking at RAE.
**Exit Image:** RAE says nothing; a bird calls thrice.
**Locks:** Trust triangulation primed.
...
**Key Beats:** **Low‑emission** layout; fallback **exit routes B/C**; perimeter leak tests.  
...
**Key Beats:** Roles fixed: Jason **cadence**, Lina **time**, Milo **eyes**, RAE **counter‑phase**, Elyra **accepts pain as telemetry**.  
...
**Key Beats:** Halt prep; Milo uncovers deep **sabotage** in tooling; decide to double‑track plan while exhausted; split attention knowingly.
...
**Key Beats:** Synchronized draw; **fractures** show at once; Elyra’s body reacts with alarming clarity; proceed anyway.
...
**Key Beats:** Environmental jolt shears pattern; Jason+RAE stabilize with quiet counter‑shape; **Lina’s surge** nearly floors her; construct holds.
...
**Key Beats:** Elyra shows first true healing; Jason hits **clean exhaustion**; ambient **noise changes**; both feel an off‑world **tick**; RAE logs **external interference** with a new overtone.
...
**Key Beats:** Debrief turns to security argument; old foe named; Elyra warns about methods; agreement: more eyes, fewer emissions.
...
**Key Beats:** Jason tries a **new ability**; controlled side effect: small, scary, instructive; Lina/Milo notice how he listens differently; next steps mapped.
...
**Key Beats:** Food and fixes; low‑grade tensions; Elyra+RAE find an anomaly not in known lattices; Jason admits he’s changed.
...
**Key Beats:** RAE intercepts a **threat**; realize someone located them; final image: a shadowed figure steps forward as resonance throbs like a held breath.
**Exit Image:** Cut to cliff on the held breath.
**Locks:** Shadow = Open Ch. 1 arrival.
...
**Key Beats:** Tight exchange; veiled history; Jason tastes field distortion like **metal**; withdrawal under pressure; RAE issues encrypted warning.
...
**Key Beats:** Simple cleanup goes wrong: bowl turns sink **milky** and **pulses**; 20‑minute neutralization; everyone knows it wasn’t an accident.
...
**Key Beats:** Travel targets sketched; ally debate; Jason accepts leadership weight; on the walk, a **glassy tone** slices city noise then dies into a not‑empty silence; in his head: *Found.*
**Exit Image:** City holds its breath for one beat too long.
**Locks:** Book II cold open ready.

---

## Continuity Locks (do not drop)
- **RAE private segment** storing Jason’s solution (Elyra‑arc Ch. 11) → becomes a trust conflict later.
- **Missing photograph** of the inscription (Search Ch. 19) → unresolved until a Book II reveal.
- **Unmarked car** tail (Search Ch. 20) → same brand/type reappears post‑ritual.
- **Street musician motif** (Search Ch. 4 → Elyra Ch. 4) → later connects to a controlled silence field.
- **Triple‑pulse core** (Elyra Ch. 7) → echoed during Ritual Ch. 5 ambient shift.
...
## Theme Echoes for Line Edits
- *Precision over power*, *listening as action*, *ethics as constraint not handicap*, *paper remembers what networks forget*.

---

### Drafting Macros (quick reference)
- Each scene: pick **one carrier** and **one human softness** (food, joke, gesture).
- If a beat risks “loud magic,” first try a **quiet, high‑quality shape**.
- End scenes with a **lock** (prop, phrase, tone) that can echo later.
- **Carrier phone alibi v0.1**: dedicated prepaid handset, ≤90s bursts + cooldown, Jason maintains contact, never record, avoid echo/glass, rotate SIM monthly.
